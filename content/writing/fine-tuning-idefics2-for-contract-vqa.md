...
description: A practical notebook for adapting Idefics2-8B to answer questions
  across multi-page contract documents.
...
I have been collecting public contract dataset for a while. `chenghao/sec-material-contracts` is an ongoing project that crawls contract documents from the [EDGAR](https://sec.gov) website. It includes both the raw html contract content and all relevant metadata.
