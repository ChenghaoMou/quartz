...
```text
Codeberg blog repository ──clone──> ignored content/
                                      │
...
### 1. Make the repository boundary reproducible
...
### 2. Make publication policy testable
...
### 3. Turn custom plugins into source packages
...
### 4. Separate design tokens from page composition

- Split `site/styles/site.scss` into tokens, foundations, chrome, home, article, search, and content
  primitives.
...
1. External-content build and policy regression suite.
2. Plugin source/build pipeline.
3. Style-module split and component gallery.
4. Browser smoke suite and CI visual artifacts.
5. Reproducible deployment metadata and upstream-merge automation.
